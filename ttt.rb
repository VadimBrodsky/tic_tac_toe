...
def initialize_board(guide=false)
  board = {}
  if guide
...
begin
  ...
  # Get user position
  begin
    print "Choose a position (1 to 9) to place 'X': "
    player_position = gets.chomp.to_i
  end until BOARD_POSITIONS.include?(player_position) && position_not_taken?(game_board, player_position)
